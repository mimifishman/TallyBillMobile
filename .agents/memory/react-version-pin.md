...
A registered validation command now guards this constraint automatically — run the project's validation checks after any react-affecting dep change instead of manually grepping bundles.
